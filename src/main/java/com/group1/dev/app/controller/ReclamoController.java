...
public class ReclamoController {
	...
	@GetMapping("/filter")
	@ResponseStatus(HttpStatus.OK)
	public ResponseEntity<ArrayList<Reclamo>> filterReclamos(
	...
	public ResponseEntity<Reclamo> findById(@PathVariable int id) {
	...
	public ResponseEntity<?> actualizarReclamo(@PathVariable Integer id, @RequestBody Reclamo reclamo) {
		...
		try {
			...
			reclamoService.update(reclamo, reclamoService.findById(id));
